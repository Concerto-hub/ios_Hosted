...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/URWAYios/iOS_Hosted_plugin'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'URWAYios' => 'user.mac@concertosoft.com' }
  s.source           = { :git => 'https://github.com/URWAYios/iOS_Hosted_plugin.git', :tag => s.version.to_s }
